	            ...
	            switch(listitem)
	            {
	                case 0:
					{
		                if (kaska[playerid] > 500)
						{
							...
							} else sendTipMessage(playerid, "Masz ju¿ telefon, najpierw wyrzuæ stary.");
							return 1;
						}
					}
					case 1:
...
//----------------------------------
    ...
    else if(dialogid == D_EDIT)
    {
        ...
        switch(listitem)
        {
            ...
            case 2:
            {
                ...
                ShowPlayerDialogEx(playerid, D_EDIT_FRAC, DIALOG_STYLE_LIST, "Edycja frakcji", lStr, "Dalej", "Wróæ");
            }
            case 3:
            {
    ...
    else if(dialogid == D_EDIT_ORG_LIST)
    {
        ...
        switch(listitem)
        {
            ...
            case 2:
            {
            	ShowPlayerDialogEx(playerid, D_EDIT_ORG_SKINS, DIALOG_STYLE_LIST, "Edycja skinów", "Poka¿ skiny\nUsuñ skiny\nDodaj Skin\n", "Wybierz", "Wróæ");
            }
            case 3:
            {
    ...
    else if(dialogid == D_EDIT_ORG_SKINS)
    {
    	...
    	switch(listitem)
        {
        	...
        	case 1:
        	{
        		ShowPlayerDialogEx(playerid, D_EDIT_ORG_SKINS_DELETE, DIALOG_STYLE_PREVMODEL, "Skiny organizacji (usuwanie)", DialogListaSkinowOrg(id), "Usuñ", "Anuluj");
        	}
        	case 2:
        	{
    ...
    {
    	if(response || !response) ShowPlayerDialogEx(playerid, D_EDIT_ORG_SKINS, DIALOG_STYLE_LIST, "Edycja skinów", "Poka¿ skiny\nUsuñ skiny\nDodaj Skin\n", "Wybierz", "Wróæ");
    }
    else if(dialogid == D_EDIT_ORG_SKINS_DELETE)
    {
    	...
    	format(query, sizeof(query), "SELECT `skins` FROM `mru_skins` WHERE `typ` = '0' AND `id` = '%d'", id);
   		...
   		if(mysql_fetch_row_format(query, "|"))
   		{
   		    ...
   		    WczytajSkiny();
   		    _MruGracz(playerid, "Skin usuniêto!");
    ...
    else if(dialogid == D_EDIT_FRAC)
    {
        ...
        ShowPlayerDialogEx(playerid, D_EDIT_FRAC_LIST, DIALOG_STYLE_LIST, "Edycja frakcji", "Zmieñ nazwê\nZmieñ skiny\nUsuñ lidera(ów)\nZmieñ spawn\nZmieñ nazwy rang", "Wybierz", "Wróæ");
        return 1;
    }
    else if(dialogid == D_EDIT_FRAC_LIST)
    {
        ...
        switch(listitem)
        {
            case 0:
            {
                ShowPlayerDialogEx(playerid, D_EDIT_FRAC_NAME, DIALOG_STYLE_INPUT, "Edycja", "WprowadŸ now¹ nazwê", "Zmieñ", "Wróæ");
            }
            case 1:
            {
            	ShowPlayerDialogEx(playerid, D_EDIT_FRAC_SKINS, DIALOG_STYLE_LIST, "Edycja skinów", "Poka¿ skiny\nUsuñ skiny\nDodaj Skin\n", "Wybierz", "Wróæ");
            ...
            {	
                ...
                fracSave(id);
                _MruGracz(playerid, sprintf("Zapisano pozycjê startow¹ dla [%d] %s", id, FracInfo[id][frac_Name]));
                return 1;
            }
            case 4:
            {
    ...
    else if(dialogid == D_EDIT_FRAC_SKINS)
    {
    	...
    	switch(listitem)
        {
        	...
        	case 1:
        	{
        		ShowPlayerDialogEx(playerid, D_EDIT_FRAC_SKINS_DELETE, DIALOG_STYLE_PREVMODEL, "Skiny frakcji (usuwanie)", DialogListaSkinow(id), "Usuñ", "Anuluj");
        	}
        	case 2:
        	{
        		ShowPlayerDialogEx(playerid, D_EDIT_FRAC_SKINS_ADD, DIALOG_STYLE_INPUT, "Skiny frakcji (dodawanie)", "Wpisz poni¿ej id skina, który chcesz dodaæ", "Ok", "Wróæ");
        	}
        }
    ...
    {
    	if(response || !response) ShowPlayerDialogEx(playerid, D_EDIT_FRAC_SKINS, DIALOG_STYLE_LIST, "Edycja skinów", "Poka¿ skiny\nUsuñ skiny\nDodaj Skin\n", "Wybierz", "Wróæ");
    }
    ...
    else if(dialogid == D_EDIT_FRAC_NAME)
    {
        ...
        if(strlen(inputtext) > 31 || strlen(inputtext) < 1) return ShowPlayerDialogEx(playerid, D_EDIT_FRAC_NAME, DIALOG_STYLE_INPUT, "Edycja", "WprowadŸ now¹ nazwê", "Zmieñ", "Wróæ");
        format(lStr, 128, "Zmieniono nazwê organizacji %s na %s", FracInfo[id][frac_Name], inputtext);
        SendClientMessage(playerid, COLOR_GREEN, lStr);
    ...
    else if(dialogid == D_SPRZEDAJAPTECZKE) 
    {
    	...
    	if(!response)
    	{
    		SendClientMessage(id, COLOR_LIGHTGREEN, sprintf("%s nie zgodzi³ siê na kupno apteczki.", GetNick(playerid)));
    		return 1;
    	}
    	...
    	if(kaska[playerid] >= 5000)
    	{
    		...
    		SendClientMessage(id, COLOR_LIGHTBLUE, sprintf("%s kupi³ od Ciebie apteczkê, dostajesz $4000!", GetNick(playerid)));
    		SendClientMessage(playerid, COLOR_LIGHTBLUE, sprintf("Kupi³eœ apteczkê za $5000 od %s!", GetNick(id)));
    		new str[128];
    		format(str, sizeof(str), "%s[%d] sprzeda³ apteczkê %s[%d] za $5000", GetNick(id), PlayerInfo[id][pUID], GetNick(playerid), PlayerInfo[playerid][pUID]);
    		PayLog(str);
    		return 1;
    	} else {
    ...
    {
    	if(!response) return 1;
    	if(strcmp(inputtext, "Nastêpna strona", true) == 0) return ShowPrzystanki(playerid, 2);
    ...
    else if(dialogid == D_PRZYSTANEK+1)
    {
    	...
    	if(strcmp(inputtext, "Nastêpna strona", true) == 0) return ShowPrzystanki(playerid, 3);
    	...
    	switch(listitem)
    	{
    		case 0: // dowód
    		{
    			if(PlayerInfo[playerid][pDowod] == 0)
    			{
    				if(kaska[playerid] >= 5000)
    				{
    					_MruAdmin(playerid, "Urzêdnik wyda³ Tobie dowód osobisty");
    		...
    		case 1: // teoria
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 5000)
    				{
    					...
    					if(PlayerInfo[playerid][pCarLic] == 2) return sendTipMessage(playerid, "Zda³eœ ju¿ test teoretyczny! Teraz musisz zdaæ egzamin praktyczny.");
    					if(PlayerInfo[playerid][pCarLic] == 3) return sendTipMessage(playerid, "Zda³eœ ju¿ test teoretyczny i egzamin praktyczny. Mo¿esz odebraæ prawo jazdy!");
    			...
    			} else return sendTipMessage(playerid, "Najpierw musisz wyrobiæ dowód osobisty!");
    		}
    		case 2: // praktyka
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 10000)
    				{
    					...
    					if(PlayerInfo[playerid][pCarLic] == 2) 
    					{
    						...
    						SendClientMessage(playerid, COLOR_GRAD2, "Musisz jeszcze odebraæ prawo jazdy!");
    		...
    		case 3: // wydanie prawka
    		{
    			...
    			{			
    				...
    				{
    					if(PlayerInfo[playerid][pCarLic] == 1) return sendTipMessage(playerid, "Masz ju¿ prawo jazdy!");
    					if(PlayerInfo[playerid][pCarLic] == 2) return sendTipMessage(playerid, "Zda³eœ tylko test teoretyczny! Zanim odbierzesz prawo jazdy musisz zdaæ egzamin praktyczny.");
    					if(PlayerInfo[playerid][pCarLic] == 3)
    					{
    						_MruAdmin(playerid, "Urzêdnik wyda³ Tobie prawo jazdy");
    		...
    		case 4: // patent zeglarski
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 100000)
    				{
    					...
    					{
    						_MruAdmin(playerid, "Urzêdnik wyda³ Tobie patent ¿eglarski");
    						DajKase(playerid, -100000);
    		...
    		case 5: // pozwolenie na bron
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 300000)
    				{
    					if(PlayerInfo[playerid][pGunLic] == 0)
    					{
    						_MruAdmin(playerid, "Urzêdnik wyda³ Tobie pozwolenie na broñ");
    						DajKase(playerid, -300000);
                        	Sejf_Add(FRAC_GOV, 300000);
							PlayerInfo[playerid][pGunLic] = 1;
						} else return sendTipMessage(playerid, "Posiadasz ju¿ pozwolenie na broñ!");
    				} else return sendTipMessage(playerid, "Nie staæ Ciê!");
    			} else return sendTipMessage(playerid, "Najpierw musisz wyrobiæ dowód osobisty!");
    		}
    		case 6: // licencja pilota
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 5400000)
    				{
    					...
    					{
    						_MruAdmin(playerid, "Urzêdnik wyda³ Tobie licencje na latanie");
    		...
    		case 7: // karta wêdkarska
    		{
    			if(PlayerInfo[playerid][pDowod] >= 1)
    			{
    				if(kaska[playerid] >= 4000)
    				{
    					...
    					{
    						_MruAdmin(playerid, "Urzêdnik wyda³ Tobie kartê wêdkarsk¹");
    						DajKase(playerid, -4000);
                        	Sejf_Add(FRAC_GOV, 4000);
							PlayerInfo[playerid][pFishLic] = 1;
						} else return sendTipMessage(playerid, "Posiadasz ju¿ kartê wêdkarsk¹!");
    				} else return sendTipMessage(playerid, "Nie staæ Ciê!");
    			} else return sendTipMessage(playerid, "Najpierw musisz wyrobiæ dowód osobisty!");
    		}
    	}
    ...
    else if (dialogid == D_GRAFFITI_MAIN)
	{
		...
		switch(listitem)
		{
			...
			case 4:
			{
				...
				} else return sendErrorMessage(playerid, "Nie stworzy³eœ jeszcze ¿adnego graffiti!");
			}
			case 5:
			{
