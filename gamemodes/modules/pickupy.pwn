...
ZaladujPickupy()
{
	...
	CreateDynamicPickup(1239, 2, 1782.1417236328,-1163.5463867188,23.828125, -1); // Downtown - Kotnikowy Gun Shop
	CreateDynamicPickup(1239, 2, 1811.40234375,-1185.9276123047,23.828125, -1); // Downtown - Kotnikowy Gun Shop
	...
	CreateDynamicPickup(1239, 2, 1494.25781250,-1022.13476562,23.46905136 , -1);//bankomat
...
Zaladuj3DTexty()
{
	...
	//CreateDynamic3DTextLabel("Praca £owcy NagrÛd", 0xFFA500AA, 322.3034,317.0233,999.1484, 30.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); //Detective Registration
   ...
   //str2 = "BACZNOå∆ \n{7CFC00}By nie zostaÊ oszukanym:\n {8B0000}1. NIGDY NIE GRAJ gdy ktoú chce graÊ o wiÍcej niø ma w {FFFFFF}/sprawdzkase [ID]\n{9ACD32}Jeøeli mimo to zostaniesz oszukany NATYCHMIAST zg≥oú ten fakt na {FFFFFF}/report{9ACD32} - oszust otrzyma od razu blocka\nGdy taka osoba otrzyma blokadÍ ty masz 10min na napisanie na niego skargi\nW ten sposÛb moøesz odzyskaÊ nawet 100 procent wygranej!!";
    ...
    str2 = "{7CFC00}Tutaj moøesz zagraÊ w ruletkÍ.\n({FFFFFF}/ruletka{7CFC00})";
	CreateDynamic3DTextLabel(str2, -1, 1038.2437,-1091.8198,-66.6043, 17.0);
	...
	CreateDynamic3DTextLabel("Ammunation Los Santos", COLOR_BLUE ,1791.212036,-1164.631713,23.828100, 15.0);
...
//-------------------------------[Przystanki autobusowe]----------------------------------------
	...
	//CreateDynamic3DTextLabel("Przystanek \n Ganton - Groove Street \n{FF8C00}/bus", COLOR_BLUE ,2474.3999023438,-1738.4000244141,16 ,20.0); //przy GS
	//CreateDynamic3DTextLabel("Przystanek \n Idlewood - Silownia \n{FF8C00}/bus", COLOR_BLUE , 2163.0180664063,-1758.4976806641,16.147880172729, 20.0); // Idlewood - Silownia przy motelu
	...
	//CreateDynamic3DTextLabel("Przystanek \n Downtown - Sπd \n Kursuje linia: {FF8C00}72(j)", COLOR_BLUE ,1336.8793945313,-1348.0667724609,16.126877403259, 20.0); // Downtown - Sπd
	//CreateDynamic3DTextLabel("Przystanek \n Downtown - Bank \n Kursuje linia: {4682B4}55  {FF8C00}72(j) {FF00FF}85", COLOR_BLUE ,1451.2653808594,-1025.9205322266,26.328125, 20.0); //przy banku
	//CreateDynamic3DTextLabel("Przystanek \n Downtown - Ammunation Los Santos \n Kursuje linia: {FF00FF}85", COLOR_BLUE ,1782.1417236328,-1163.5463867188,26.328125, 20.0); // Downtown - Ammunation Los Santos
	...
	//CreateDynamic3DTextLabel("Przystanek \n Jefferson - KoúciÛ≥ \n Kursuje linia: {4682B4}55", COLOR_BLUE ,2220.5141601563,-1438.9367675781,26.0, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Idlewood - Skate Park \n Kursuje linia: {4682B4}55", COLOR_BLUE ,1859.5150146484,-1392.0882568359,15.5625, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Market - Szpital \n Kursuje linia: {FF8C00}72 {FF00FF}85", COLOR_BLUE ,1213.7967529297,-1315.9571533203,16.557159423828, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Lotnisko Los Santos - Terminale \n Nie kursuje øadna linia.", COLOR_BLUE ,1672.7529296875,-2261.7868652344,15.529561042786, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Lotnisko Los Santos - Pas Startowy \n Kursuje linia: {008000}96", COLOR_BLUE ,1977.9957275391,-2174.1936035156,15.540592193604, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Marina - Molo \n Nie kursuje øadna linia.", COLOR_BLUE ,816.23620605469,-1792.2507324219,15.663411140442, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Rodeo - Granica \n Nie kursuje øadna linia.", COLOR_BLUE ,172.44171142578,-1569.1838378906,14.701812744141, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Rodeo - Wypozyczalnia Aut \n Kursuje linia: {008000}96", COLOR_BLUE ,579.77905273438,-1242.9088134766,19.654222488403, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Marina - Burger Shot \n Kursuje linia: {008000}96", COLOR_BLUE ,821.37451171875,-1622.2203369141,17.546875, 20.0); //
	//CreateDynamic3DTextLabel("Przystanek \n Las Collinas - Bar El'Pueblo \n Kursuje linia: {FF00FF}85", COLOR_BLUE ,2192.2785644531,-1016.5588989258,63.465999603271, 20.0); //
...
//3d texty wejscia
	...
	CreateDynamic3DTextLabel("Przejúcie do cel\n Uøyj: /wejdz", COLOR_GRAD1, 1549.83, -1642.90, 28.50, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 2);//138

	CreateDynamic3DTextLabel("Wyjúcie", COLOR_PANICRED,  1555.37, -1642.92, 28.5, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 2);//nowe komi
