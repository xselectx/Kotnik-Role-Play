...
//new PlayerText:TextAdminLog[MAX_PLAYERS]; warningi DO POPRAWY
...
new Text:Wybieralka_Arrow_Right, Text:Wybieralka_Arrow_Left, Text:Wybieralka_Confirm;
...
LoadTXD()
{
    ...
    Kara_TDraw = TextDrawCreate(10.000000, 262.000000, "~r~Ban Offline~n~~w~Dla:~y~ Nick~n~~w~Admin:~y~ Nick~n~~w~Powod:~y~ Test");
    TextDrawFont(Kara_TDraw, 1);
    TextDrawLetterSize(Kara_TDraw, 0.312499, 1.250000);
    TextDrawTextSize(Kara_TDraw, 160.500000, 108.500000);
    TextDrawSetOutline(Kara_TDraw, 1);
    TextDrawSetShadow(Kara_TDraw, 0);
    TextDrawAlignment(Kara_TDraw, 1);
    TextDrawColor(Kara_TDraw, -1);
    TextDrawBackgroundColor(Kara_TDraw, 255);
    TextDrawBoxColor(Kara_TDraw, 86);
    TextDrawUseBox(Kara_TDraw, 0);
    TextDrawSetProportional(Kara_TDraw, 1);
    TextDrawSetSelectable(Kara_TDraw, 0);
    ...
    Pasek = TextDrawCreate(638.000000, 439.000000, "-");
    TextDrawFont(Pasek, 1);
    TextDrawLetterSize(Pasek, 0.200000, 2.449999);
    TextDrawTextSize(Pasek, 396.000000, 19.500000);
    TextDrawSetOutline(Pasek, 1);
    TextDrawSetShadow(Pasek, 0);
    TextDrawAlignment(Pasek, 3);
    TextDrawColor(Pasek, -1);
    TextDrawBackgroundColor(Pasek, 255);
    TextDrawBoxColor(Pasek, 131);
    TextDrawUseBox(Pasek, 1);
    TextDrawSetProportional(Pasek, 1);
    TextDrawSetSelectable(Pasek, 0);
    
    /*Pasek2 = TextDrawCreate(638.000000, 439.000000, "-");
    TextDrawFont(Pasek2, 1);
    TextDrawLetterSize(Pasek2, 0.000000, -0.900000);
    TextDrawTextSize(Pasek2, 400.000000, 17.000000);
    TextDrawSetOutline(Pasek2, 1);
    TextDrawSetShadow(Pasek2, 0);
    TextDrawAlignment(Pasek2, 3);
    TextDrawColor(Pasek2, -1);
    TextDrawBackgroundColor(Pasek2, 255);
    TextDrawBoxColor(Pasek2, 50);
    TextDrawUseBox(Pasek2, 1);
    ...
    TextDrawSetOutline(PasekName, 0);
    TextDrawSetShadow(PasekName, 0);
    TextDrawAlignment(PasekName, 1);
    TextDrawColor(PasekName, -2686721);
    TextDrawBackgroundColor(PasekName, 255);
    TextDrawBoxColor(PasekName, 50);
    TextDrawUseBox(PasekName, 0);
    TextDrawSetProportional(PasekName, 1);
    TextDrawSetSelectable(PasekName, 0);
    
    PasekHour = TextDrawCreate(638.000000, 437.000000, "00:00");
    TextDrawFont(PasekHour, 1);
    TextDrawLetterSize(PasekHour, 0.179166, 0.900000);
    TextDrawTextSize(PasekHour, 400.000000, 17.000000);
    TextDrawSetOutline(PasekHour, 0);
    TextDrawSetShadow(PasekHour, 0);
    TextDrawAlignment(PasekHour, 3);
    TextDrawColor(PasekHour, -1);
    TextDrawBackgroundColor(PasekHour, 255);
    TextDrawBoxColor(PasekHour, 50);
    TextDrawUseBox(PasekHour, 0);
    TextDrawSetProportional(PasekHour, 1);
    TextDrawSetSelectable(PasekHour, 0);
...
UnloadTXD()
{
    ...
    TextDrawDestroy(Pasek2);
    TextDrawDestroy(PasekName);
    TextDrawDestroy(PasekHour);
...
stock fMSGBOX_Init()
{
    ...
    MSGBOXtd_Kubi = TextDrawCreate(414.000000, 118.000000, " ");
...
stock Wybieralka_Load()
{
    Wybieralka_Arrow_Right = TextDrawCreate(374.000000, 327.000000, ">>>");
    TextDrawFont(Wybieralka_Arrow_Right, 1);
    TextDrawLetterSize(Wybieralka_Arrow_Right, 0.612500, 2.000000);
    TextDrawTextSize(Wybieralka_Arrow_Right, 421.500000, 17.500000);
    TextDrawSetOutline(Wybieralka_Arrow_Right, 2);
    TextDrawSetShadow(Wybieralka_Arrow_Right, 0);
    TextDrawAlignment(Wybieralka_Arrow_Right, 1);
    TextDrawColor(Wybieralka_Arrow_Right, -1);
    TextDrawBackgroundColor(Wybieralka_Arrow_Right, 255);
    TextDrawBoxColor(Wybieralka_Arrow_Right, 50);
    TextDrawUseBox(Wybieralka_Arrow_Right, 0);
    TextDrawSetProportional(Wybieralka_Arrow_Right, 0);
    TextDrawSetSelectable(Wybieralka_Arrow_Right, 1);

    Wybieralka_Arrow_Left = TextDrawCreate(219.000000, 327.000000, "<<<");
    TextDrawFont(Wybieralka_Arrow_Left, 1);
    TextDrawLetterSize(Wybieralka_Arrow_Left, 0.612500, 2.000000);
    TextDrawTextSize(Wybieralka_Arrow_Left, 265.000000, 17.500000);
    TextDrawSetOutline(Wybieralka_Arrow_Left, 2);
    TextDrawSetShadow(Wybieralka_Arrow_Left, 0);
    TextDrawAlignment(Wybieralka_Arrow_Left, 1);
    TextDrawColor(Wybieralka_Arrow_Left, -1);
    TextDrawBackgroundColor(Wybieralka_Arrow_Left, 255);
    TextDrawBoxColor(Wybieralka_Arrow_Left, 50);
    TextDrawUseBox(Wybieralka_Arrow_Left, 0);
    TextDrawSetProportional(Wybieralka_Arrow_Left, 0);
    TextDrawSetSelectable(Wybieralka_Arrow_Left, 1);

    Wybieralka_Confirm = TextDrawCreate(304.000000, 352.000000, "OK");
    TextDrawFont(Wybieralka_Confirm, 1);
    TextDrawLetterSize(Wybieralka_Confirm, 0.516666, 2.000000);
    TextDrawTextSize(Wybieralka_Confirm, 421.500000, 17.500000);
    TextDrawSetOutline(Wybieralka_Confirm, 2);
    TextDrawSetShadow(Wybieralka_Confirm, 0);
    TextDrawAlignment(Wybieralka_Confirm, 1);
    TextDrawColor(Wybieralka_Confirm, -1);
    TextDrawBackgroundColor(Wybieralka_Confirm, 255);
    TextDrawBoxColor(Wybieralka_Confirm, 50);
    TextDrawUseBox(Wybieralka_Confirm, 0);
    TextDrawSetProportional(Wybieralka_Confirm, 1);
    TextDrawSetSelectable(Wybieralka_Confirm, 1);
}

stock Wybieralka_Unload()
{
    TextDrawDestroy(Wybieralka_Arrow_Right);
    TextDrawDestroy(Wybieralka_Arrow_Left);
    TextDrawDestroy(Wybieralka_Confirm);
}
