...
public OnGameModeInit()
{
	...
	//timery
	SetTimer("AktywujPozar", 7200000, true);//System PoøarÛw v0.1
...
OnPlayerLogin(playerid, password[])
{
	...
	{//poprawne has≥o
        ...
        //SendClientMessage(playerid, COLOR_LIGHTRED, "ªª Administracja øyczy wszystkim graczom weso≥ych úwiπt! (/czapka)");
