...
public AktywujPozar()
{
	...
	if(losowy == 1)
	{
    	...
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: DOM JEDNORODZINNY - IDLEWOOD");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH KUCHENKI GAZOWEJ");
	...
	else if(losowy == 2)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: SKLEP 24/7 W OKOLICACH DMV");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: AWARIA INSTALACJI ELEKTRYCZNEJ");
	...
	else if(losowy == 3)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: PIZZERIA IDLEWOOD");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: AWARIA KUCHENKI GAZOWEJ");
	...
	else if(losowy == 4)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: SKLEP BINCO - GANTON");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 5)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: KONTENERY - LOSTNISKO LOS SANTOS");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH");
	...
	else if(losowy == 6)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: P•CZKARNIA NA MARKET");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 7)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: BAR W DILLIMORE");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 8)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: URZ•D MIASTA PALOMINO CREEK");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
	...
	else if(losowy == 9)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: SKLEP 24/7 - IDLEWOOD");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 10)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: MOTEL JEFFERSON");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 11)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: SALON AUT");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
	...
	else if(losowy == 12)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: GUNSHOP OBOK BAZY LSFD");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: PODPALENIE");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRACOWNIK");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 13)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: BUDYNEK OBOK BIUROWCA FBI");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
	...
	else if(losowy == 14)
	{
		SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
    	SendFamilyMessage(4, 0xAA3333AA, "           UWAGA: WYBUCH£ POØAR!");
    	SendFamilyMessage(4, 0xAA3333AA, "MIEJSCE POØARU: BUDYNEK OBOK VINYL CLUB");
    	SendFamilyMessage(4, 0xAA3333AA, "PRZYCZYNA POØARU: WYBUCH INSTALACJI ELEKTRYCZNEJ");
    	SendFamilyMessage(4, 0xAA3333AA, "ZG£OSI£: PRZECHODZIE—");
    	SendFamilyMessage(4, 0xAA3333AA, "         !!!!UDAJ SI  NA MIEJSCE!!!!");
    	SendFamilyMessage(4, 0xFFFFFFAA, "--------[EMERGENCY RESCUE SERVICE]--------");
...
public Spectator()
{
	...
	foreach(Player, i)
	{
		...
		{
			printf("%s [%d] dosta≥ kicka za uøywanie jetpacka", GetNick(i), i);
			KickEx(i);
		}
                        ...
                        case 4://nÛø
    					{
    						if(PlayerInfo[i][pGun1] != 4 && PlayerInfo[i][pMember] != 8 && PlayerInfo[i][pLider] != 8)
    						{
                                ...
                                else
                                {
        							...
        							SendAdminMessage(0x9ACD32AA, sprintf("AC: %s [ID: %d] dosta≥ kicka. | PowÛd: Spawn Broni", GetNick(i), i));
        							KickEx(i);
                                }
    						}
    					}
			...
			if(gPlayerLogged[i] == 1 || TutTime[i] >= 1)
			{
				if(playerState == 1 || playerState == 2 || playerState == 3)
				{
                    ...
                    switch(weaponID)
                    {
    					...
    					case 37:
    					{
    						format(string, sizeof(string), "* %s wyciπga Miotacz Ognia.", specNAME);
    						ProxDetector(10.0, i, string, COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE,COLOR_PURPLE);
    					}
	...
	foreach(Player, i)
	{
		if(gPlayerLogged[i] == 1)
		{
			...
			if(PlayerPos[i][0] == PlayerPos[i][3] && PlayerPos[i][1] == PlayerPos[i][4] && PlayerPos[i][2] == PlayerPos[i][5])
			{
				...
				{
					SendClientMessage(i, 0xAA3333AA, "Zosta≥eú skickowany za zbyt d≥ugi bezruch!");
					KickEx(i);
				}
			}
	...
	foreach(Player, i)
	{
		if(gPlayerLogged[i] == 1)
		{
			if(PlayerInfo[i][pAdmin] < 1 && PlayerInfo[i][pNewAP] < 1)
			{
				...
				if(PlayerPos[i][0] == PlayerPos[i][3] && PlayerPos[i][1] == PlayerPos[i][4] && PlayerPos[i][2] == PlayerPos[i][5])
				{
					SendClientMessage(i, 0xAA3333AA, "Porusz siÍ! Za minutÍ zostaniesz skickowany za bezruch!");
				}
			}
		}
	}
...
public JednaSekundaTimer()
{
    ...
    foreach(Player, i)
	{
        ...
        if(GetPlayerWeapon(i)) {
            //ABroadCast(COLOR_YELLOW, sprintf("[Blokady]: Gracz %s [%d] prÛbuje omijaÊ blokadÍ posiadania bronii", GetNick(playerid), playerid), 1);
            sendTipDialogMessage(i, sprintf("Posiadasz aktywnπ blokadÍ posiadania broni. Pozosta≥o: %dh", PlayerInfo[i][pBBron]));
            ResetPlayerWeaponsEx(i);
            UsunBron(i);
        	}
    	}
		...
		else if(repairTimerVar[i] == 0 && repairInProgress[i] == 1)
        {
            ...
            sendTipDialogMessage(i, sprintf("Zap≥aci≥eú %d$ za naprawÍ pojazdu u mechanika", MECHS_COST_REPAIR));
            DajKase(i, -MECHS_COST_REPAIR);
            format(C_STRING, sizeof(C_STRING), "%s zap≥aci≥ %d za naprawÍ pojazdu u NPC", GetNick(i), MECHS_COST_REPAIR);
            PayLog(C_STRING);
        ...
        else if(robTimerVar[i] == 0 && robInProgress[i] == 1)
        {
            ...
            sendTipDialogMessage(i, sprintf("{FFFFFF}Wyciπgnπ≥eú z kasy: {8FCB04}${FFFFFF}%d",val));
		...
		if(PlayerInfo[i][pJailed] == 3) // anty ucieczka z AJ
    	{
    		if(!IsPlayerInRangeOfPoint(i, 10.0, 1481.1666259766,-1790.2204589844,156.7875213623))
    		{
    			...
    			sendErrorMessage(i, "PrzywrÛcono pozycjÍ!");
    		}
    	}
        ...
        if(SafeTime[i] > 0)//3minuty na zalogowanie
		{
			...
			if(SafeTime[i] == 1)
			{
				if(gPlayerAccount[i] == 1 && gPlayerLogged[i] == 0)
				{
					if(!IsPlayerNPC(i))
					{
						printf("%s [%d] zosta≥ wyrzucony za nie zalogowanie siÍ w 3 minuty.", GetNick(i), i);
						KickEx(i);
					}
				}
			}
...
public CheckAmmo(i)
{
	...
	if(IsPlayerConnected(i) && gPlayerLogged[i] == 1 && AntySpawnBroni[i] == 0)
	{
		...
		{
			AmmoWarn[i] = 0;
			//SendClientMessage(i, COLOR_PANICRED, "Dosta≥eú kicka od systemu, powÛd: Spawn Amunicji");
   		 	//SendAdminMessage(0x9ACD32AA, sprintf("AC: %s [%d] czituje. | PowÛd: Spawn Amunicji (przed: %d po: %d)", GetNick(i), i));
      			//KickEx(i);
		}
	}
}
